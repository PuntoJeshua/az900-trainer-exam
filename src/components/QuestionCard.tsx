        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-slate-700 transition-all duration-300 relative group">
            ...
            <div className="flex items-start gap-4 mb-6 pr-12">
                <span className={clsx(
                    ...
                    question.complexity === 'Basico' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' :
                        question.complexity === 'Intermedio' ? 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400' :
